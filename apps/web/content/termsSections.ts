...
export const TERMS_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      `${SERVICE_NAME} is a desktop capture tool for Windows. The Service lets you frame a 9×16 or 16×9 region of your screen, record video (and optional audio), use Game mode for locked full-frame capture, preview recordings inside the app, and—once you have purchased Pro—export decrypted MP4 files locally or to Google Drive.`,
